...
-   Use **knowledge base** (runbooks/articles) to suggest next steps and
    ground drafts in approved procedures (knowledge snippets are
    included in the payload; see doc 02)
...
Steps: 1. Identify warehouse site 2. Pull health snapshot 3. Pull
relevant knowledge base articles (by category, CI, or search) 4. Apply
policy rules 5. Call LLM (with incident + snapshot + knowledge snippets
+ logs) 6. Update incident fields 7. Notify resolver groups
